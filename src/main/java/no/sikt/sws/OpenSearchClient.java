...
public class OpenSearchClient {
    ...
    private final HttpResponseHandler<String> httpResponseHandler = new HttpResponseHandler<>() {
        @Override
    ...
    private final HttpResponseHandler<SdkBaseException> errorResponseHandler = new HttpResponseHandler<>() {
        @Override
