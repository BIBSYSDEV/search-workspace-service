...
class SnapshotRoutineDeletionHandlerTest {
  ...
  void processInput() throws IOException {
    var testCase = new CaseLoader(TEST_CASE_FILE).getTestCase("GET (all) snapshots");
    ...
    when(openSearchClient.sendRequest(GET, GET_URL_ALL, null)).thenReturn(mockResponse);
