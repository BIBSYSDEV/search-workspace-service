...
public final class Utils {
  ...
  public static Map<String, String> buildPathParamsForIndex(String index) {
    return Map.of(RESOURCE_IDENTIFIER, index);
  }
  ...
  public static InputStream buildRequest(
      HttpMethod httpMethod, Map<String, String> pathParams, String scopeClaim)
  ...
  public static <T> InputStream buildRequestWithBody(
      HttpMethod httpMethod, Map<String, String> pathParams, T body, String scopeClaim)
      throws JsonProcessingException {
