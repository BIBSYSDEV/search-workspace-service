...
public class SnapshotRegisterRepoHandler extends ApiGatewayHandler<Void, String> {
  ...
  protected String processInput(Void input, RequestInfo requestInfo, Context context)
      throws ApiGatewayException {
    var settings =
        new SnapshotSettingsRequestDto(BACKUP_BUCKET_NAME, null, BACKUP_ROLE_ARN, "snapshots");
    ...
    try {
      ...
      var response =
          openSearchClient.sendRequest(HttpMethodName.PUT, SNAPSHOT_REPO_PATH_REQUEST, requestStr);
