...
public class InternalIndexDto {
  ...
  public InternalIndexDto(
      JsonNode aliases, JsonNode mappings, JsonNode settings, String indexLink) {
  ...
  public static InternalIndexDto fromOpenSearchIndex(
      Map.Entry<String, OpenSearchIndexDto> mapEntry, String workspacePrefix) {
